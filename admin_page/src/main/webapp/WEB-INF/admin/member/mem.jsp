...
<body>
		...
		<tbody>
			...
			<tr>
				<td><input type="checkbox" class="rowCheckbox"
					name="selectedMembers" value="Park456"></td>
				<td>박*태</td>
				<td>1995-05-15</td>
				<td>Park456</td>
				<td>010-9876-5432</td>
			...
			<tr>
				<td><input type="checkbox" class="rowCheckbox"
					name="selectedMembers" value="Lee789"></td>
				<td>이*섭</td>
				<td>1995-12-30</td>
				<td>Lee789</td>
				<td>010-5555-6666</td>
			...
			<tr>
				<td><input type="checkbox" class="rowCheckbox"
					name="selectedMembers" value="Kim459"></td>
				<td>김*영</td>
				<td>1997-12-30</td>
				<td>Kim459</td>
				<td>010-5555-6666</td>
	...
	<div class="click">
		...
		<button type="button" onclick="deselectAll()">전체삭제</button>
			<button type="submit" name="action" value="deleteSelected">선택삭제</button>
		</div>
	</form>
			</div>
		</div>
