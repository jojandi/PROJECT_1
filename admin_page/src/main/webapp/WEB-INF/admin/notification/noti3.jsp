					...
					<div id="back">
						<table>
							...
							<tbody>
								...
								<tr>
									<td id="info" class="book">-“역사는 우리를 저버렸지만, 그래도 상관없다”
									역사에 외면당한 재일조선인 가족의 대서사극
								전 세계를 감동시킨 이민진 작가 화제작 《파친코》 새롭게 출간!</td>
								</tr>
								<tr class="cart">
						...
						<table>
							...
							<tbody>
								...
								<tr>
									...
									-하구독자 23만 명 ‘더메시지랩’ 채널을 이끄는 유튜버이자, 
									이 시대가 받아들이고 이해할 수 있는 언어로 젊은 세대와 활발히 
									소통하는 저자가 모든 것이 불안한 청년에게 답이 되는 든든한 말을 들고 찾아왔다.
									</td>
								</tr>
								<tr class="cart">
